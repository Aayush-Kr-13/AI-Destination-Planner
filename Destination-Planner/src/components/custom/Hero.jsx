...
function Hero()  {
  return (
    <div className="flex flex-col items-center mx-56 gap-9">
        ...
        <p className='text-xl text-gray-500 text-center '>Your personal trip planner and travel curator,creating custom itineraries tailored to uour interests and budget.</p>
